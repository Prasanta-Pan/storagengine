...
abstract class AbstractFileHandler {
	...
	protected void sync(RandomAccessFile rF) throws Exception { sync(rF.getChannel()); }
	protected void sync(FileChannel fc) throws Exception { fc.force(true); }
